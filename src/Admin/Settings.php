...
class Settings {
			...
			'general' => [
				...
				'fields' => [
					...
					'wwa_rate_limit'      => [
						...
						'min'         => 0,
						'max'         => 1000,
						'suffix'      => __( 'per minute', 'hookly-webhook-automator' ),
					],
				],
			],
			'logging' => [
				...
				'fields' => [
					...
					'wwa_max_log_entries'    => [
						...
						'min'         => 0,
						'max'         => 100000,
						'suffix'      => __( 'entries', 'hookly-webhook-automator' ),
					],
				],
			],
		];
	...
	public function render(): void {
		...
		<div class="wrap wwa-wrap">
			...
			<form method="post" action="">
				...
				<div class="wwa-card" style="margin-bottom: 20px;">
					...
					<div class="wwa-card-body">
						<table class="form-table">
							...
							<tr>
								<th scope="row"><?php esc_html_e( 'WordPress Version', 'hookly-webhook-automator' ); ?></th>
				...
				<p class="submit">
					<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Settings', 'hookly-webhook-automator' ); ?></button>
				</p>
			</form>
		</div>
		<?php
	...
	public function handleSubmit( array $data ): array {
		...
		return [
			'success' => true,
			'message' => __( 'Settings saved successfully.', 'hookly-webhook-automator' ),
		];
	}
}
